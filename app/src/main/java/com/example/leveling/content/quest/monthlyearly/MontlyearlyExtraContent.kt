...
@Composable
fun MonthlyearlyQuestCard(questCardContent: QuestCardContent) {
                            ...
                            db.collection("Users").document(userId)
                                .update(
                                    mapOf(
                                        ...
                                        "exp" to FieldValue.increment(1000)
                                    ))
                                .addOnSuccessListener {
...
@Composable
fun ModifyMonthlyearlyQuestCard(questCardContent: QuestCardContent, onEditClick:(QuestCardContent) -> Unit, onDeleteClick:(QuestCardContent) -> Unit) {
    var done by remember { mutableStateOf(questCardContent.done) }
...
@Composable
fun DeleteMonthlyearlyQuestDialog(questCardContent: QuestCardContent, onDismiss:() -> Unit, onDelete: (QuestCardContent) -> Unit) {
    Dialog(
...
@Composable
fun EditMonthlyearlyQuestDialog( questCardContent: QuestCardContent, onDismiss:() -> Unit, onSave: (QuestCardContent) -> Unit) {
    ...
    Dialog(
        ...
        Box(
            ...
            Column(
                ...
                Text("Add New Montly / Yearly Quest")
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            onSave(questCardContent.copy(title = title, description = description, reward = reward))
                            title = ""
                            description = ""
                            reward = ""
                            onDismiss()
...
@Composable
fun AddMontlyearlyDialog( showDialog: Boolean, onDismiss:() -> Unit, onAdd: (String, String, String, Boolean) -> Unit) {
