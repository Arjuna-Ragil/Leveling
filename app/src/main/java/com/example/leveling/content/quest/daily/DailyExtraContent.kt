...
@Composable
fun ModifyDailyQuestCard(questCardContent: QuestCardContent, onEditClick: (QuestCardContent) -> Unit, onDeleteClick: (QuestCardContent) -> Unit) {
...
@Composable
fun DeleteQuestDialog( questCardContent: QuestCardContent ,onDismiss:() -> Unit, onDelete: (QuestCardContent) -> Unit) {
    Dialog(
...
@Composable
fun EditQuestDialog( questCardContent: QuestCardContent, onDismiss:() -> Unit, onSave: (QuestCardContent) -> Unit) {
